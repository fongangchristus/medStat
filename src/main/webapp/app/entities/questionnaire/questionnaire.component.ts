...
export class QuestionnaireComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.questionnaireService
                ...
                .subscribe(
                    (res: HttpResponse<IQuestionnaire[]>) => this.paginateQuestionnaires(res.body, res.headers),
    ...
    protected paginateQuestionnaires(data: IQuestionnaire[], headers: HttpHeaders) {
